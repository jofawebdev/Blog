...
<title> Jofawebdev - CASE STUDY </title>
  ...
  <!-- This is how you add your image below --> 
          ...
          <!-- Navbar on Top -->
        <div class="w3-top">
            <div class="w3-bar w3-wide w3-black w3-padding w3-card" id="myNavbar">
            ...
            <i class="fa fa-bars"></i></a>
                ...
                <div class="w3-right">
                    ...
                    <a href="Portfolio" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-text-theme"><b>Portfolio</b></a>
            ...
            <div id="navsmall" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium">
                ...
                <a href="Portfolio" class="w3-bar-item w3-button w3-white"><b>Portfolio</b></a><hr>
