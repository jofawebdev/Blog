...
<title>Register - Create Account</title>
        <!-- This is how you add your image below --> 
          ...
          <meta property="og:title" content="Jofawebdev: Register / Create Account">
...
<div style="background-image: url(images/crop-2240391463.jpg); background-attachment: fixed;  
...
<div class="col-sm-6 col-lg-12 col-md-12">
	<div class="card-header">
				<h3 class="w3-text-orange"><b>CREATE AN ACCOUNT</b></h3>
			</div>			 
          		...
          		<div class="col-lg-6 col-md-6 col-sm-6">
                     <div class="d-flex">
	    				...
	    				<div class="form-group">
	    					<label for="postal_code">Username</label>
	    					<input type="text" name="username" class="form-control" placeholder="James11" required/>
	    				</div>
	    				<div class="form-group">
	    					<label for="postal_code">Email</label>
	    					<input type="text" class="form-control" placeholder="jojo@yandex.com" name="email" required/>
			        	</div>
	              <div class="form-group">
	                <label for="postal_code">Date of birth</label>
	                <input type="date" class="form-control" id="book_off_date" name="dob" placeholder="Date of Birth" required/>
	              </div>
	             </div>


	             <div class="col-md-6 col-sm-6 col-xs-6 w3-container">
	              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="post_code" placeholder="Postal code" class="form-control" required/>
              </div>
          
	              <div class="form-group">
	                <label for="postal_code">Date of registration</label>
	                <input type="date" class="form-control" id="book_off_date" name="dor" placeholder="Date of Birth" required/>
	              </div>
                <div class="d-flex">
                <div class="form-group mr-2">
                  <label for="postal_code">Password</label>
                  <input type="password" name="password" class="form-control" placeholder="XD$v12@kl" required/>
                </div>
                <div class="form group mr-2">
                  <label for="postal_code">Confirm Password</label>
                  <input type="password" name="password2" placeholder="XD$v12@kl" class="form-control" required/>
                </div>
              </div>
              <div class="form-group w3-button">
...
<p> <span>Already have an account?</span><a href="login.php"><b>  <span class="w3-text-orange">Log In</span> </b></a></p>
</div>
